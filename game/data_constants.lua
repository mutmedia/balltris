...
FRAMES_TO_STATIC = 20
MIN_SPEED = 5
COMBO_INCREMENT_SCORE = 0.2 * TIME_SCALE_REGULAR -- seconds
COMBO_INCREMENT_DROP = 0.27 * TIME_SCALE_REGULAR -- seconds
COMBO_MAX_TIMEOUT = 1 * TIME_SCALE_REGULAR -- seconds
