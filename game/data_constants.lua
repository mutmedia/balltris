...
FRAMES_TO_STATIC = 20
MIN_SPEED = 5
COMBO_MAX_TIMEOUT = 0.75 * TIME_SCALE_REGULAR -- seconds
COMBO_INCREMENT_SCORE = 0.2 * TIME_SCALE_REGULAR * COMBO_MAX_TIMEOUT-- seconds
COMBO_INCREMENT_DROP = 0.2 * TIME_SCALE_REGULAR -- seconds
