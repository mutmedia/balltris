...
-- Tutorial states
STATE_TUTORIAL_NONE = 32
STATE_TUTORIAL_AIMBALL = 1
STATE_TUTORIAL_DROPBALL = 2
STATE_TUTORIAL_COMBO = 4
STATE_TUTORIAL_LOSECOMBO = 8
STATE_TUTORIAL_CLEARCOMBO = 16
STATE_TUTORIAL_SLOMO = 64
STATE_TUTORIAL_SCORE = 128
STATE_TUTORIAL_WHITEBALLS = 256
STATE_TUTORIAL_SLOMO_OPTIONS = 512
STATE_TUTORIAL_COMBOMETER_DROP = 1024
STATE_TUTORIAL_COMBOMETER_SCORE = 2048
STATE_TUTORIAL_NEW_COMBO_CLEARSAT = 4096

-- Tutorial things
TUTORIAL_MIN_TIME = 0.5
TUTORIAL_SCORE_TIMEOUT_AFTERHIT = 0.2 * TIME_SCALE_REGULAR
